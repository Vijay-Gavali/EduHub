...
<body>
	...
	<!-- ✅ Navbar -->
	<nav
		class="navbar navbar-expand-lg navbar-dark nav-bg fixed-top ms-1 me-1">
		<div class="container ">
			...
			<div class="collapse navbar-collapse" id="navbarNav">
				<ul class="navbar-nav ms-auto nav-textcolor">
					...
					<li class="nav-item"><a class="nav-link "
						href="studentlife.html">Student Life</a></li>
	...
	<div class="container-fluid py-5 form-color ">
		<div class="text-center mb-4">
			...
			<p class="text-dark">Edu Hub provides a balanced and
				comprehensive curriculum designed to nurture curiosity, creativity,
				and lifelong learning among students.</p>
		</div>
		<div class="row g-4">
			<!-- Elementary -->
			<div class="col-md-4 ">
				<div class="card h-100 form-color-h">
					<img src="./media/SCHOOL BOYS.jpg" class="card-img-top"
						alt="Elementary School">
					<div class="card-body">
						<h4 class="card-title text-dark ">Elementary School (Grades
							1–5)</h4>
						<p class="card-text">Focus on foundational learning in
							literacy, numeracy, and creativity. Emphasis on joyful learning
			...
			<div class="col-md-4">
				<div class="card h-100 form-color-h ">
					<img src="./media/ELEMENTRY SCHOOL.jpg" class="card-img-top"
						alt="Junior School">
					<div class="card-body">
						<h4 class="card-title text-dark">Junior School (Grades 6–8)</h4>
						<p class="card-text">Development of analytical and
							problem-solving skills, introduction to advanced sciences,
							languages, and digital literacy.</p>
					</div>
				</div>
			</div>
			<!-- High -->
			<div class="col-md-4">
				<div class="card h-100 form-color-h ">
					...
					<div class="card-body">
						...
						<p class="card-text">Rigorous curriculum preparing students
							for board exams, competitive tests, and future career
							opportunities.</p>
					</div>
				</div>
			</div>
	...
	<div class="card  w-100 border-0 rounded-0  ">
		<div class="row g-0 align-items-stretch form-color-h">
			...
			<div class="col-md-8 d-flex">
				<div
					class="card-body d-flex flex-column justify-content-center ms-5 p-4 w-100">
					<h3 class="card-title mb-3 ms-3 text-dark">Our Teaching
						Methodology</h3>
					<ul class="mb-0">
			...
			<div class="row">
				...
				<div class="col-md-4 text-center">
					...
					<ul class="list-unstyled  ">
						...
						<li><a href="index.html#admission"
