...
<body>
	...
	<div class="form-container">
		<form action="AdminStudentRegistration" method="post">
			...
			<div class="form-group">
				<label>Aadhar Number:</label> <input type="text" name="aadhar_no" />
			</div>

			<div class="form-group">
				<label>Parent Aadhar Number:</label> <input type="text"
					name="parent_aadhar" />
			</div>
			...
			<div class="form-group">
				<label>Phone Number (Parent):</label> <input type="text"
					name="contact_no" />
			</div>
			...
			<div class="form-group">
				<label>Select Class:</label> <select name="class_id" required>
