...
public class UserRegistration extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // Teacher-related code is not needed
            //String classIdStr = request.getParameter("class_id");
            //int class_id = (classIdStr != null && !classIdStr.isEmpty()) ? Integer.parseInt(classIdStr) : 0;
            ...
            String insertQuery = "INSERT INTO users (admission_no, admission_date, name, father_name, mother_name, dob, "
                    ...
                    + "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)"; // will set class_id as NULL for Parents
            ...
            e.printStackTrace(out); // show error if something goes wrong
        }
    }
}
